...
class SiparisController extends Controller
{
    ...
    public function siparis_detay($id){
        ...
        $urunler=DB::select('SELECT s.*,u.resim as resim FROM siparis_detay s ,urunler u WHERE s.urun_id=u.ID AND s.siparis_id=?',[$id]);
    ...
    public function siparis_update(Request $request, $id)
    {
        ...
        return redirect('admin/siparis_detay/'.$id)->with('success','Sipariş Güncellendi');
    }
}
